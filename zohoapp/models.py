...
class vendor_tableE(models.Model):
    ...
    battention=models.CharField(max_length=100,default='',null=True)
    bcountry=models.CharField(max_length=100,default='',null=True)
    baddress=models.CharField(max_length=300,default='',null=True)
    bcity=models.CharField(max_length=100,default='',null=True)
    bstate=models.CharField(max_length=100,default='',null=True)
    bzip=models.CharField(max_length=100,default='',null=True)
    bphone=models.CharField(max_length=100,default='',null=True)
    bfax=models.CharField(max_length=100,default='',null=True)
    sattention=models.CharField(max_length=100,default='',null=True)
    scountry=models.CharField(max_length=100,default='',null=True)
    saddress=models.CharField(max_length=300,default='',null=True)
    scity=models.CharField(max_length=100,default='',null=True)
    sstate=models.CharField(max_length=100,default='',null=True)
    szip=models.CharField(max_length=100,default='',null=True)
    sphone=models.CharField(max_length=100,default='',null=True)
    sfax=models.CharField(max_length=100,default='',null=True)
