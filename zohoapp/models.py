...
class ExpenseE(models.Model):
    ...
    vendor= models.ForeignKey(vendor_tableE, on_delete=models.CASCADE,null=True, blank=True)
    ...
    customer_name = models.ForeignKey(addcustomerE, on_delete=models.CASCADE,null=True, blank=True)
